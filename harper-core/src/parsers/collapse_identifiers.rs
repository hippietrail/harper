...
mod tests {
    ...
    fn one_collapse() {
        ...
        dict.append_word_str("separated_identifier", LexemeMetadata::default());
    ...
    fn kebab_collapse() {
        ...
        let mut dict = MutableDictionary::new();
        dict.append_word_str("separated-identifier", LexemeMetadata::default());
    ...
    fn double_collapse() {
        ...
        let mut dict = MutableDictionary::new();
        dict.append_word_str("separated_identifier_token", LexemeMetadata::default());
    ...
    fn overlapping_identifiers() {
        ...
        let mut dict = MutableDictionary::new();
        dict.append_word_str("separated_identifier", LexemeMetadata::default());
        dict.append_word_str("identifier_token", LexemeMetadata::default());
