...
mod tests {
    ...
    fn dont_flag_random_words_that_happen_to_end_like_a_particle() {
        assert_lint_count("I like bacon.", "en", PhrasalVerbAsCompoundNoun::default(), 0);
    }

    #[test]
    fn dont_flag_non_verb_particles() {
        assert_lint_count("non", "en", PhrasalVerbAsCompoundNoun::default(), 0);
    }
    ...
    fn dont_flag_checkin() {
        ...
        assert_lint_count("checkin", "en", PhrasalVerbAsCompoundNoun::default(), 0);
    }

    #[test]
    fn dont_flag_cleanup() {
        assert_lint_count("cleanup", "en", PhrasalVerbAsCompoundNoun::default(), 0);
    }
    ...
    fn flag_checkout_after_you() {
        assert_lint_count("you checkout", "en", PhrasalVerbAsCompoundNoun::default(), 1);
    }
    ...
    fn flag_cleanup_after_they() {
        assert_lint_count("they cleanup", "en", PhrasalVerbAsCompoundNoun::default(), 1);
    }

    #[test]
    fn dont_flag_dictionary_lookup() {
        assert_lint_count("dictionary lookup", "en", PhrasalVerbAsCompoundNoun::default(), 0);
    }

    #[test]
    fn flag_couples_breakup() {
        assert_lint_count("couples breakup", "en", PhrasalVerbAsCompoundNoun::default(), 1);
    }

    #[test]
    fn dont_flag_gallon() {
        assert_lint_count("gallon", "en", PhrasalVerbAsCompoundNoun::default(), 0);
    }
