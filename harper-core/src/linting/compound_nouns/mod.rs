...
mod tests {
    ...
    fn web_cam() {
        ...
        assert_suggestion_result(test_sentence, "en", CompoundNouns::default(), expected);
    }
    ...
    fn got_is_not_possessive() {
        assert_lint_count("I got here by car...", "en", CompoundNouns::default(), 0);
    }
    ...
    #[test]
    fn allow_issue_661() {
        assert_lint_count("I may be wrong.", "en", CompoundNouns::default(), 0);
    }
