...
mod tests {
    ...
    fn ignores_correct_phrase() {
        assert_lint_count("Here's how to clone the repository.", "en", HowTo::default(), 0);
    }
    ...
    #[test]
    fn how_are_you() {
        assert_lint_count("How are you?", "en", HowTo::default(), 0);
    }

    #[test]
    fn how_calm_you_are() {
        assert_lint_count("I like how calm you are.", "en", HowTo::default(), 0);
    }
    ...
    fn dont_flag_how_did_you() {
        assert_lint_count("How did you get to school every day?", "en", HowTo::default(), 0);
    }
}
